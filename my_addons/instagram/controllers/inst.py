...
ABS_PATH_TO_GECKODRIVER = '/home/alex/PycharmProjects/inst/instascraper/geckodriver'  # input your abs dir to driver http://i.imgur.com/SBjMsj9.png
...
def func_name():
    with webdriver.Firefox(executable_path=ABS_PATH_TO_GECKODRIVER, options=options) as browser:
        email_username_login = info_post_for_login['user_login']
        my_pass = info_post_for_login['user_pass']
        required_username_to_search = info_post_for_login['required_acc_to_find']
        qty_req_posts = int(info_post_for_login['qty_posts'])
